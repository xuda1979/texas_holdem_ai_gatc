...
def create_simple_card_images() -> int:
    ...
    suit_symbols = {"h": "♥", "d": "♦", "c": "♣", "s": "♠"}  # hearts  # diamonds  # clubs  # spades
...
def download_fancy_card_deck() -> bool:
...
def check_missing_cards() -> tuple[int, list[str]]:
