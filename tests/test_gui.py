...
class TestPokerGameGUI(unittest.TestCase):
    ...
    def test_gui_initialization(
        self, mock_tk, mock_load_images, MockTexasHoldem, mock_setup_gui, mock_start_game
    ):
    ...
    def test_get_card_image_key(self, mock_tk, mock_load_images, MockTexasHoldem):
        ...
        with (
            patch.object(PokerGameGUI, "setup_gui", MagicMock()),
    ...
    def test_handle_player_actions(
        self, mock_messagebox, mock_tk, mock_load_images, MockTexasHoldem
    ):
        ...
        with (
            ...
            mock_messagebox.showwarning.assert_called_with(
                "Not your turn", "It's not your turn to act."
            )
