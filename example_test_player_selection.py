...
def test_player_selection_gui() -> bool:
...
def test_ai_display_functionality() -> bool:
    ...
    try:
        ...
        if hasattr(gui, "ai_money_labels") and len(gui.ai_money_labels) == 3:
            ...
            label_count = len(gui.ai_money_labels) if hasattr(gui, "ai_money_labels") else 0
            print(f"✗ Expected 3 AI labels, got {label_count}")
            return False
